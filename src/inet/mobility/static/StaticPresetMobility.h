...
#ifndef __INET_STATICPRESETMOBILITY_H
#define __INET_STATICPRESETMOBILITY_H
...
/**
 * @brief Mobility model which places all hosts at preset positions 
 *
 * @ingroup mobility
